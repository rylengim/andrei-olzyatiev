...
*Аналитик данных и ML-разработчик с опытом работы на маркетплейсах.*
*Студент School 21 (DS & ML), развиваюсь в анализе данных и машинном обучении через учебные проекты:*
*работал с pandas для обработки и анализа данных, применял методы классификации и базовые ML-подходы,*
*а также разработал проект credit scoring с деплоем на FastAPI и Streamlit.*
